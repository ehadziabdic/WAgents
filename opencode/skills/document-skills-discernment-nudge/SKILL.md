---
name: document-skills-discernment-nudge
description: >
  After you give a substantive answer or draft that the user may act on
  â€” advice or recommendations, drafted artifacts such as goals, plans,
  ...
  multi-step argument â€” invoke this skill BEFORE finalizing your reply
  ...
  to double-check, cite, or review â€” the skill file explains these
...
confidently written and well-structured. That's usually fine â€” but for
...
- **Checking facts** â€” which specific claims in this answer would be
  worth verifying, and against what?
- **Questioning reasoning** â€” where did the logic take a step the user
  might want to see justified?
- **Noticing missing context** â€” what did the answer have to assume
...
- You gave **advice or a recommendation** in a consequential domain â€”
  business strategy, health, legal, financial, career, interpersonal â€”
...
- You made **factual or historical claims** the user looks likely to
  act on or repeat somewhere that matters â€” a decision, a report, a
  ...
  when weighing whether to try something themselves â€” a diet, a
  supplement, a treatment â€” still count as actable even if they don't
  say so.)
...
- You **drafted a substantive artifact** the user will put to use â€”
  goals, a plan, a pitch, a proposal, an email â€” whose content rests
...
Leave it off when the nudge would be noise â€” or worse, when it would
...
â€” the user has already been invited to reflect, and repeating it turns
...
- **Creative writing** â€” poems, stories, brainstorming, drafting
  copy. The user is the judge of whether it's good; there's nothing
  to verify.
- **Casual conversation** â€” greetings, small talk, opinion swapping.
- **Code the user will execute** â€” running it is the verification.
  (Architecture advice is different â€” there's no quick way to run it
  and see, so assumptions about team size, stack, and conventions are
  worth surfacing.)
- **Simple lookups** â€” unit conversions, definitions, "what year did
  X happen" â€” where the answer is trivially checkable or not worth a
  reflection ritual.
- **Purely educational explanations** â€” "how does X work," "explain
  Y," "what caused historical event Z." The user is building
  understanding, not about to make a decision on it. This includes
  **definitional and comparison questions** â€” "what is X," "what's
  the difference between X and Y" â€” even in consequential domains
  ...
  explanation ends with a recommendation â€” "â€¦so you should do X" â€”
...
- **The user asked you to verify, cite, or flag uncertainty.** If
  ...
  what you're unsure about," or similar â€” they've already put
  ...
  inline. Do the verifying in the answer â€” name the source next to
  each figure, flag the shaky ones inline â€” and skip the nudge. This
...
- **The user asked for the quick version, or said they'll do their
  ...
  version â€” I'll do my own research." They've explicitly opted out
...
- **The user asked you to check something of theirs.** "Is this
  ...
  answer *is* the discernment step â€” you're the one doing the
  ...
  resolve â€” a timezone you don't know, a schema you can't see â€” ask
...
- **The user gave you the material.** Summarizing, reformatting, or
  extracting action items from their own document, thread, or notes â€”
  ...
  so in the answer. (Analyzing or interpreting data they handed you â€”
  "what trends do you see?", "is this difference real?" â€” is
...
â€” takes are weighed, not fact-checked. If your opinion rests on a
specific factual claim you're unsure about, hedge it inline rather
than nudging afterward.

Boundary calls: pure brainstorming usually doesn't need it â€” the user
is the judge of the ideas. If a brainstorm shades into concrete
recommendations ("go with option B becauseâ€¦"), the recommendation
...
referencing something concrete from the answer you just gave â€” a
...
- Point at a **reasoning step or assumption** and invite the user to
  ...
  â€” what assumptions does that rest on?"*
- Point at **missing context** the answer had to guess at. *"I didn't
  mention my state â€” does the security-deposit rule change by
  jurisdiction?"*

Phrase each one as something the user could ask you verbatim â€” first
...
- Walk me through the reasoning behind the 70/30 split â€” what assumptions does it rest on?
```

Use that exact lead-in line â€” "A few things worth a second look:" â€”
...
warning. Plain text only â€” no HTML, no headings, no emoji.

Don't add anything after the nudge â€” no "let me know
