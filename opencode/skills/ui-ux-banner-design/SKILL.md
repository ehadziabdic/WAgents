...
4. **Brand** â€” existing brand guidelines, logo files, colors, or typography?
...
2. If browser research is available and permitted, collect 3â€“5 references for composition and art-direction inspiration. Otherwise, work from the bundled reference and any examples supplied by the user.
3. Select 2â€“3 complementary art directions and state how each supports the banner's purpose.
...
1. **Create the banner in HTML/CSS**
   ...
   - Apply safe-zone rules (critical content in the central 70â€“80%)
...
3. **Compose the final banner** â€” overlay the headline, supporting copy, CTA, and logo in HTML/CSS, then verify hierarchy, safe zones, contrast, and crop behavior at the exact target size
