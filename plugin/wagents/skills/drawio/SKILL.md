...
1. **draw.io CLI** (pixel-perfect, fastest) â€” used automatically if draw.io desktop is installed
2. **Official draw.io viewer in headless browser** (pixel-perfect, needs Chromium/Edge) â€” fallback when CLI is unavailable
