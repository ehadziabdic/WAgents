...
description: Use when testing OAuth 2.0 implementations for authorization-code interception, redirect_uri, CSRF, state, PKCE, scope, token leakage, or chaining flaws.
---
...
- **Hardening Extensions**:
  ...
  - Senderâ€‘constrained tokens (DPoP, mTLS)
...
### OAuth â†’ Full Account Takeover

1. **Open Redirect â†’ Authorization Code Theft**:
...
2. **CSRF â†’ Account Linking Attack**:
...
### OAuth â†’ Lateral Movement

1. **Token Exchange â†’ Service Impersonation**:
...
2. **Scope Elevation â†’ Privilege Escalation**:
...
3. **IdP Confusion â†’ Cross-Tenant Access**:
...
### OAuth â†’ Backend Exploitation

1. **JWT Algorithm Confusion â†’ Signature Bypass**:
...
2. **SSRF via redirect_uri â†’ Internal Service Access**:
...
3. **Token Replay â†’ Session Hijacking**:
