...
description: Use when testing file-upload endpoints for MIME, extension, magic-byte, path, stored-XSS, processing, or race-condition flaws.
---
...
- **CVE-2024-29510 â€“ Ghostscript â‰¤ 10.03.0 EPS/JPG RCE**: Exploit via EPS-in-JPG polyglot when Ghostscript is used for image conversion.
- **CVE-2024-53677 â€“ Apache Struts S2-067**: Multipart upload path-traversal leading to RCE.
- **CVE-2024-57169 â€“ SOPlanning â‰¤ 1.53**: Arbitrary file upload to the web-root.
- **CVE-2024-48514 â€“ php-heic-to-jpg â‰¤ 1.0.5**: Filename sanitisation bypass resulting in RCE during HEIC conversion.
...
- Use presigned URLs with **short TTL (â‰¤ 60 s)** and **single-use** semantics.
