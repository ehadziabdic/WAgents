...
description: Use when testing web applications for duplicate-parameter parsing differences, frontend/backend desynchronization, WAF bypass, or parameter injection.
---
...
param=value1&pÎ±ram=value2  # Greek alpha instead of 'a'
...
- **Header/Cookie Pollution**: Conflicting header values across CDN â†’ WAF â†’ app layers
