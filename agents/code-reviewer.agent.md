...
- `/superpowers requesting-code-review` — the review request protocol (what a reviewable diff must contain).
- `/superpowers receiving-code-review` — how to structure findings and respond to author pushback.
- `/superpowers verification-before-completion` — verify that reported fixes actually resolved the findings.
