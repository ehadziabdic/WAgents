...
tools: ['read', 'search', 'github', 'context7', 'codebase-memory']
---
...
- `awesome-security-review` — security-relevant findings: data flows, injection, authz, secrets.
- `mcp-codebase-memory` — inspect call sites and blast radius of a change before flagging it.
