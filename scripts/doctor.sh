...
test -d "$ROOT/.github/skills/base-hacker-claude-red/vendor/Claude-Red/Skills" && echo "[ok] hacker vendor" || echo "[info] hacker vendor not installed (use --include-hacker)"
