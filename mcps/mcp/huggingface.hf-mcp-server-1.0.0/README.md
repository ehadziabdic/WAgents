...
in the separate [`hf-mcp-optimise`](https://github.com/huggingface/hf-mcp-server/blob/main/docs/benchmarking.md) workspace.
...
For the eight-hour repair schedule and read-only dashboard, follow [`monitor/README.md`](https://github.com/huggingface/hf-mcp-server/blob/main/monitor/README.md).
...
[`monitor/README.md`](https://github.com/huggingface/hf-mcp-server/blob/main/monitor/README.md) for retry and manual-reset policy.
